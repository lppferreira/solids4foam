...
#include "timeVaryingLinearElastic.H"
...
namespace Foam
{
    defineTypeNameAndDebug(timeVaryingLinearElastic, 0);
    addToRunTimeSelectionTable
    (
        mechanicalLaw, timeVaryingLinearElastic, linGeomMechLaw
    );
}
...
void Foam::timeVaryingLinearElastic::makeSigma0f() const
{
    if (sigma0fPtr_)
    {
        FatalErrorIn("void Foam::timeVaryingLinearElastic::makeSigma0f() const")
...
const Foam::surfaceSymmTensorField& Foam::timeVaryingLinearElastic::sigma0f() const
{
    if (!sigma0fPtr_)
    {
        makeSigma0f();
...
void Foam::timeVaryingLinearElastic::correctTimeVaryingElasticParameters()
{
...
void Foam::timeVaryingLinearElastic::calculateHydrostaticStress
(
...
)
{
    if (solvePressureEqn_)
    {
        ...
        else
        {
            FatalErrorIn
            (
                "void Foam::timeVaryingLinearElasticMisesPlastic::"
...
Foam::timeVaryingLinearElastic::timeVaryingLinearElastic
(
    const word& name,
    const fvMesh& mesh,
    ...
    sigma0fPtr_(NULL)
{
    ...
    else
    {
        FatalErrorIn
        (
            "timeVaryingLinearElasticMisesPlastic::timeVaryingLinearElasticMisesPlastic::()"
        )   << "Either initial and desired E and transition period or E and nu "
            << "or mu and K elastic parameters should be specified" << abort(FatalError);
    }
...
Foam::tmp<Foam::volScalarField> Foam::timeVaryingLinearElastic::rho() const
{
...
Foam::tmp<Foam::volScalarField> Foam::timeVaryingLinearElastic::bulkModulus() const
{
    tmp<volScalarField> tresult
    (
        new volScalarField
...
const Foam::dimensionedScalar& Foam::timeVaryingLinearElastic::rhoScalar() const
{
    return rho_;
}


Foam::tmp<Foam::volScalarField> Foam::timeVaryingLinearElastic::impK() const
{
    if (nu_.value() == 0.5)
    {
...
const Foam::dimensionedScalar& Foam::timeVaryingLinearElastic::mu() const
{
    return mu_;
}


const Foam::dimensionedScalar& Foam::timeVaryingLinearElastic::K() const
{
    return K_;
}


const Foam::dimensionedScalar& Foam::timeVaryingLinearElastic::E() const
{
    return E_;
}


const Foam::dimensionedScalar& Foam::timeVaryingLinearElastic::nu() const
{
    return nu_;
}


const Foam::dimensionedScalar& Foam::timeVaryingLinearElastic::lambda() const
{
    return lambda_;
}


void Foam::timeVaryingLinearElastic::correct(volSymmTensorField& sigma)
{
...
void Foam::timeVaryingLinearElastic::correct(surfaceSymmTensorField& sigma)
{
    // Update elastic parameters
    correctTimeVaryingElasticParameters();
