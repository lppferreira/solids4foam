...
)
{
    ...
    // Global coefficients - to allow correct parallelisation
            ...
            if (!emptyFace)
            {
                ...
                forAll(curFaceEdges, edgeI)
                {
                    ...
                    forAll(sePointIDs, pointI)
                    {
                        ...
                        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
                        //~            Add coeffs for proc faces             ~//
                        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//

                        // These are the cells on other procs which are directly
                        // accessible through proc faces
                        ...
                        // These are cells on other procs that are not directly
                        // accessible through the proc faces
