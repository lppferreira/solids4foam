...
#include "newConsistentIcoFluid.H"
#include "volFields.H"
#include "fvm.H"
#include "fvc.H"
...
defineTypeNameAndDebug(newConsistentIcoFluid, 0);
addToRunTimeSelectionTable(fluidSolver, newConsistentIcoFluid, dictionary);


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

newConsistentIcoFluid::newConsistentIcoFluid(const fvMesh& mesh)
:
...
const volVectorField& newConsistentIcoFluid::U() const
{
    return U_;
}


const volScalarField& newConsistentIcoFluid::p() const
{
    return p_;
}
...
// tmp<vectorField> newConsistentIcoFluid::patchViscousForce(const label patchID) const
// {
//     tmp<vectorField> tvF
//     (
...
// tmp<scalarField> newConsistentIcoFluid::patchPressureForce(const label patchID) const
// {
//     tmp<scalarField> tpF
//     (
...
// //- Patch viscous force (N/m2)
// tmp<vectorField> newConsistentIcoFluid::faceZoneViscousForce
// (
//     const label zoneID,
//     const label patchID
// ) const
...
// //- Patch pressure force (N/m2)
// tmp<scalarField> newConsistentIcoFluid::faceZonePressureForce
// (
//     const label zoneID,
//     const label patchID
// ) const
...
// tmp<scalarField> newConsistentIcoFluid::faceZoneMuEff
// (
//     const label zoneID,
//     const label patchID
// ) const
...
void newConsistentIcoFluid::evolve()
{
